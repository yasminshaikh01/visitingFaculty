...
<div className="bg-[#FFFFFF] border border-[#C3C5D8] rounded-[12px] p-6">
                ...
                <div className="grid grid-cols-2 gap-y-5 gap-x-4">
                  ...
                  {/* UPDATED: Force Email and ID to take their own rows on mobile (col-span-2) but share a row on desktop (sm:col-span-1) */}
                  <div className="col-span-2 sm:col-span-1">
                    <p className="text-[12px] text-[#585F6C] mb-1">Email Address</p>
                    <p className="text-[14px] font-medium text-[#141B2B] break-all">{faculty?.email || "—"}</p>
                  </div>
                  <div className="col-span-2 sm:col-span-1">
